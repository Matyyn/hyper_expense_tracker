          ...
          <View className="bg-surface border border-line rounded-3xl p-5 mb-4">
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-1 pr-3">
                <Text className="text-ink text-sm font-semibold">Daily Log Reminder</Text>
                <Text className="text-muted text-xs mt-0.5">Show a banner on the wallet if you haven't logged today</Text>
              </View>
              {reminderBusy ? (
